...
def save_discover_weekly():
    ...
    if not saved_weekly_playlist_id:
        new_playlist = sp.user_playlist_create(user_id, 'Saved Weekly', public=True, collaborative=False, description="created through a python script and cron job on GHA :)")
